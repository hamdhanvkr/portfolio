...
import { SiTailwindcss, SiMysql, SiPostgresql, SiDjango, SiMongodb } from "react-icons/si";

const skillCategories = [
    {
        title: "Frontend Development",
        skills: [
            { name: "HTML", icon: <FaHtml5 />, color: "text-orange-500", level: "92%" },
            { name: "CSS", icon: <FaCss3Alt />, color: "text-blue-500", level: "92%" },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "MySQL", icon: <SiMysql />, color: "text-blue-500", level: "95%" },
                ...
                <div className="space-y-12">
                    {skillCategories.map((category, catIdx) => (
                        <div key={catIdx} className="relative">
                            <h3 className="text-lg font-bold text-slate-400 uppercase tracking-widest mb-6 block">
                                {category.title}
                            </h3>
                            ...
                            >
                                {category.skills.map((skill, index) => (
                                    ...
                                    >
                                        <div className={`text-3xl ${skill.color} mr-4 lg:text-5xl`}>
                                            {skill.icon}
                                        </div>

                                        <div className="flex-1">
                                            <div className="flex justify-between items-center mb-1">
                                                <span className="text-md lg:text-xl font-bold text-slate-700">{skill.name}</span>
